...
namespace ZaynBot
{
    public class ModuloCliente
    {
        ...
        private Task Client_Ready(ReadyEventArgs e)
        {
            ...
            Client.UpdateStatusAsync(new DiscordActivity("z!ajuda - V. VINLAND 1.1", ActivityType.Streaming), UserStatus.DoNotDisturb);
        ...
        private Task Client_GuildAvailable(GuildCreateEventArgs e)
        {
            ...
            BotCore.QuantidadeServidores++;
            BotCore.QuantidadeMembros += e.Guild.MemberCount;
            BotCore.QuantidadeCanais += e.Guild.Channels.Count;
            return Task.CompletedTask;
        }
